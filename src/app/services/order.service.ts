...
makeOrderRest(obj):Observable<object>{
  this.httpOptions = {
   ...
   return this.http.post("https://organic-api-management.azure-api.net/orders/all",obj,this.httpOptions)
} 

getOrdersByUsername():Observable<object>{
  let user=sessionStorage.getItem("username");
  return this.http.get("https://organic-api-management.azure-api.net/orders/all/"+user);
}

getOrders():Observable<object>{

  return this.http.get("https://organic-api-management.azure-api.net/orders/all/");
}
}
